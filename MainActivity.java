...
public class MainActivity extends AppCompatActivity {
    ...
    public void LoginFunction(){
        ...
        if(EditTextEmptyHolder) {
            ...
            cursor = sqLiteDatabaseObj.query(Database.TABLE_NAME, null, " " + Database.Table_Column_1_UserName + "=?", new String[]{UsernameHolder}, null, null, null);
            ...
            while (cursor.moveToNext()) {
                ...
                if (cursor.isFirst()) {
                    ...
                    TempPassword = cursor.getString(cursor.getColumnIndex(Database.Table_Column_3_Password));
